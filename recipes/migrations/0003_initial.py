...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('recipes_recipe_categories')
        ...
        db.create_table('recipes_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['recipes.Category'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('recipes_recipe_categories'))
    ...
    models = {
        ...
        'recipes.category': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['recipes.Category']"}),
        ...
        'recipes.recipe': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['recipes.Category']", 'symmetrical': 'False'}),
